...
--补花的声音
function MusicManager:playEffectBuhua( sex )
	-- body
	-- local random = math.random(5)
	local sound_path = ""
	if tonumber(sex) == 1 then
		sound_path = "hall/majiangsound/common_man/buhua.mp3"
	else
		sound_path = "hall/majiangsound/common_man/buhua.mp3"
	end
	self:playEffect(sound_path)
...
--财飘的声音
function MusicManager:playEffectCaiPiao(sex)
	-- body
	-- local random = math.random(5)
	local sound_path = ""
	if tonumber(sex) == 1 then
		sound_path = "hall/majiangsound/common_man/piaocai.mp3"
	else
		sound_path = "hall/majiangsound/common_man/piaocai.mp3"
	end
	self:playEffect(sound_path)
